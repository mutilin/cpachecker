...
public class ThreadCreateTransformer {
  ...
  private final static String CREATE = "pthread_create";
  ...
  public void transform(CFA cfa) throws CParserException {
    ...
    for (CFAEdge edge : threadVisitor.threadCreates.keySet()) {
      ...
      CExpression newThreadFunction = args.get(2);
      List<CExpression> pParameters = Lists.newArrayList(args.get(3));
      ...
      if (pDeclaration.getParameters().isEmpty()) {
        pParameters = Lists.newArrayList();
      }
