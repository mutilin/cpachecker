...
public class CPAThreadAlgorithm implements Algorithm, StatisticsProvider {
  ...
  public static class CPAAlgorithmFactory {
    ...
    public CPAThreadAlgorithm newInstance() {
      return new CPAThreadAlgorithm(cpa, logger, shutdownNotifier, forcedCovering, reportFalseAsUnknown);
    }
  }

  public static CPAThreadAlgorithm create(ConfigurableProgramAnalysis cpa, LogManager logger,
      Configuration config, ShutdownNotifier pShutdownNotifier) throws InvalidConfigurationException {
  ...
  private CPAThreadAlgorithm(ConfigurableProgramAnalysis cpa, LogManager logger,
  ...
  private boolean handleState(
    ...
    try {
      successors = (Collection<AbstractState>) transferRelation.getAbstractSuccessors(state, precision);
    } finally {
